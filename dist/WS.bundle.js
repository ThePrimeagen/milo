...
"use strict";
/* WEBPACK VAR INJECTION */(function(Buffer) {/* unused harmony export utils */
var exportObj;
if (false) {}
if (true) {
    var sha1_1 = __webpack_require__(9);
    var atob_1 = __webpack_require__(11);
    var btoa_1 = __webpack_require__(13);
    exportObj = {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(Buffer) {/* unused harmony export ab2str */
/* unused harmony export uint8ArrayWriteString */
/* unused harmony export str2ab */
/* unused harmony export arrayBufferSlice */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return uint8ArraySlice; });
/* unused harmony export arrayBufferConcat */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return uint8ArrayConcat; });
/* harmony import */ var _nrdp__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(1).Buffer, __webpack_require__(12)(module)))
...
function parse64BigInt(buffer, offset) {
    ...
    // @ts-ignore
    // TODO michael fix me
    return BigInt("0x" + Object(utils["b" /* uint8ArraySlice */])(buffer, offset, offset + 8).toString('hex'));
}
;
...
var headerPool = new BufferPool(MAX_HEADER_SIZE);
...
var framer_WSFramer = /** @class */ (function () {
        ...
        do {
            if (state.state === State.Waiting ||
                ...
                if (nextPtrOffset === false) {
                    state.state = State.WaitingForCompleteHeader;
                    state.payload = Object(utils["b" /* uint8ArraySlice */])(packet, ptr, endIdx);
                    break;
                }
                else {
                    // @ts-ignore
    ...
    WSFramer.prototype.pushFrame = function (state) {
        ...
        if (state.payloads.length) {
            ...
            buf = utils["a" /* uint8ArrayConcat */].apply(undefined, state.payloads);
            state.payloads = null;
        }
        // TODO: Continuation Frame
        // TODONE: *** YEAH
...
var nrdp = __webpack_require__(0);
